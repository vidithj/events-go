...
func main() {
	...
	var (
		serviceName   = flag.String("service.name", "events", "Name of microservice")
		basePath      = flag.String("service.base.path", "events", "Name of microservice")
		...
		httpPort      = flag.Int("http.port", 8084, "This is the port at which http requests are accepted (Default :8080)")
		metricsPort   = flag.Int("metrics.port", 8085, "HTTP metrics listen address (Default 8082)")
